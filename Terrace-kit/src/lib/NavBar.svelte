<script lang="ts">
    ...
    const settings = {link: "settings/weather", icon: "ion:settings-outline", endPoint: "/settings/weather"};
                    ...
                    {#if $page.url.pathname === "/"}
                        <a href="/{settings.link}">
                            <button class="" on:click={() => handleClick()}>
                                <div class="text-5xl bg-original-card-bg-dark text-original-muted p-2
